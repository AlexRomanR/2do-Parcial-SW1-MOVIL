...
class LecturasComunicadoView extends StatelessWidget {
  final Comunicado comunicado;
  final List<LectorComunicado> lecturas;

  const LecturasComunicadoView({
    Key? key,
