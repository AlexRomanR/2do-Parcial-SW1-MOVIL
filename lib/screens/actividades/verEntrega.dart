...
class VerEntregaViews extends StatefulWidget {
  final Entrega entrega;

  const VerEntregaViews({Key? key, required this.entrega}) : super(key: key);

  @override
  _VerEntregaViewsState createState() => _VerEntregaViewsState();
}

class _VerEntregaViewsState extends State<VerEntregaViews> {
  ...
  void initState() {
    ...
    mediaURL = (widget.entrega.urlPublica ?? '').replaceAll('dl=0', 'dl=1');
    print('El URL de media es: $mediaURL');

    if (widget.entrega.formatoArchivo == 'mp4' || widget.entrega.formatoArchivo == 'mp3') {
      _initializeMediaFromPublicURL();
    } else if (widget.entrega.formatoArchivo == 'pdf') {
      _loadPdf();
    }
  }
  ...
  void _initializeMediaFromPublicURL() async {
    if (mediaURL.isNotEmpty) {
      if (widget.entrega.formatoArchivo == 'mp4') {
      ...
      } else if (widget.entrega.formatoArchivo == 'mp3') {
        try {
  ...
  Widget build(BuildContext context) {
    ...
    String imageUrl = widget.entrega.urlPublica.substring(0, widget.entrega.urlPublica.length - 1) + '1';
    print(imageUrl);

    return Scaffold(
      appBar: AppBar(
        title: Text('Detalle del Entrega', style: TextStyle(color: Colors.white)),
        backgroundColor: Colors.black,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                widget.entrega.estudianteNombre,
                style: TextStyle(
                  color: Colors.orange,
                  fontSize: 24,
            ...
            Center(
              child: Text(
                widget.entrega.fechaEntrega.toString(),
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 16,
                ),
            ...
            FutureBuilder<String?>(
              ...
              builder: (context, snapshot) {
                ...
                if (widget.entrega.formatoArchivo == 'jpg' || widget.entrega.formatoArchivo == 'png') {
                ...
                } else if (widget.entrega.formatoArchivo == 'mp4') {
